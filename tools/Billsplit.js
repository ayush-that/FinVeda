document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('calculateBillSplitBtn').addEventListener('click', function () {
    ...
    document.getElementById('clearBillSplitBtn').addEventListener('click', function () {
